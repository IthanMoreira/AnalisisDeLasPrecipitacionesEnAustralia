## Actividad - Muestreo
# Base de datos: Encuesta Nacional de Salud.xlsx  ("Población")

###########################
# 1. Seleccionar una m.a.s. de n=500 y estimar proporcion de diabéticos
###########################
...
head(muestra1)
#####################################################
# Proporcion de diabéticos estimados en base a la muestra
...
# Proporcion de diabéticos "Población"
...
###########################
# obtener los "tamaños poblacionales por sexo"
table(Pobl$Sexo)
Nh=1471 ; nh = 225
Nm=1780 ; nm = 275
# - usando seleccion
...
###########################
# 3.- muestreo estratificado por fumador de tamaño 250 para cada
# estrato, ¿Cuál es la proporción de diabéticos?
###########################
# obtener los "tamaños poblacionales por FUMADOR"
table(Pobl$Fumador)
NFum=1130 ; nFum = 250
NNFu=2121 ; nNFu = 250
# - usando seleccion
...
## para muestreo sistemático debemos instalar y cargar:
install.packages("remotes")
remotes::install_github("DFJL/SamplingUtil")

# seleccionamos los "indices" en forma sistemática
N=nrow(Pobl) ; n=300
...
colnames(estimac)=c("Población","m.a.s.","Estraf-sexo","Estraf-Fum","Sistemático")
#########################################
